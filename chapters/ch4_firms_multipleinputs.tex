...
g_{K K}\left[p\left(f_{L K} \frac{d K^{*}}{d w}+f_{L L} \frac{d L^{*}}{d w}\right)-1\right]-f_{L K} p\left(f_{K K} \frac{d K^{*}}{d w}+f_{K L} \frac{d L^{*}}{d w}\right)=0.
\end{cases}$$
Simplifying yields 
$$\begin{cases}
p f_{K K} f_{L L} \frac{d K^{*}}{d w}-p f_{K L}^{2} \frac{d K^{*}}{d w}+g_{K L}=0 \\
