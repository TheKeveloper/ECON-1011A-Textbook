...
\begin{description}
    ...
    \begin{align*}
        \frac{a^* p_a}{y} = \alpha
    \end{align*} 
    $a^* p_a$ is how much is spent on good $a$, and its ratio with respect to income is $\alpha$. Similar analysis applies for good $b$. This is a key shortcut that can help you with solving problems involving Cobb-Douglas utility much more quickly. 
\end{description}