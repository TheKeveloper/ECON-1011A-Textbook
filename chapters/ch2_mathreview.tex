...
We can finally use the concepts and ideas developed in these first two chapters to work through an example of an economic model. Note that it is not yet essential to understand all the details of this example at this point in the course. The example is included here to provide a glimpse into the typical problem-solving strategy in this class; we will revisit this general procedure several times in various concepts during the course.
